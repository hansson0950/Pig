...
class TestGame(unittest.TestCase):
    ...
    def setUp(self):
        """Create player objects and game object for testing."""
    ...
    def test_game_one_player(self, mock_player_name,
                             mock_player_turn, mock_computer_turn):
        """Test the game of one player."""
    ...
    def test_play_turn_computer(self, mock_dice_roll, mock_computer_moves):
        ...
        self.assertTrue(self.game.play_turn_computer(self.player2,
                                                     self.player1))
